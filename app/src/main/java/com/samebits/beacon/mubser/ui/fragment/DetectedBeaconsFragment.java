...
import com.samebits.beacon.mubser.ui.adapter.BeaconAdapter;
import com.samebits.beacon.mubser.ui.adapter.DetectedBeaconAdapter;
import com.samebits.beacon.mubser.ui.view.ContextMenuRecyclerView;
import com.samebits.beacon.mubser.ui.view.DividerItemDecoration;
...
public class DetectedBeaconsFragment extends ScanFragment implements BeaconAdapter.OnBeaconLongClickListener {
    ...
    @Override
    public void updateBeaconList(Collection<Beacon> beacons, org.altbeacon.beacon.Region region) {
    ...
    public void updateBeaconList(final Collection<Beacon> beacons) {
        ...
        for (int i = 1 ; i < beaconList.size() ; i++){
            ...
            if (beaconList.get(i).getDistance() < beaconList.get(i-1).getDistance()){
                beacon1 = beaconList.get(i);
                beacon2 = beaconList.get(i-1);
            }else {
                beacon2 = beaconList.get(i);
                beacon1 = beaconList.get(i-1);
            }
        }
    ...
    private void setBeaconsSignatures(){
